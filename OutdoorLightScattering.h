...
static const CPUTControlID ID_HELP_TEXT_PANEL = 30;
static const CPUTControlID ID_IGNORE_CONTROL_ID = -1;
static const CPUTControlID CONTROL_PANEL_IDS[] = {ID_MAIN_PANEL, ID_ADDITIONAL_ATTRIBS_PANEL};
...
private:
    ...
    CPUTDropdown* m_pSelectPanelDropDowns[2];
